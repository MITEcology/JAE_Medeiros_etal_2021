...
# across the feasibility domain of a 3-species antagonistic system
...
# save plot
if (save_plots) {
  orca(fig_A, "figs/figSI/fig1/fig1_A_antagonism.pdf", format = "pdf",
       width = 700, height = 450)
}
...
# save plot
if (save_plots) {
  orca(fig_B, "figs/figSI/fig1/fig1_B_antagonism.pdf", format = "pdf",
       width = 700, height = 450)
}
...
# save plot
if (save_plots) {
  orca(fig_C, "figs/figSI/fig1/fig1_C_antagonism.pdf", format = "pdf",
       width = 700, height = 450)
}
...
# save plot
if (save_plots) {
  orca(fig_D, "figs/figSI/fig1/fig1_D_antagonism.pdf", format = "pdf",
       width = 700, height = 450)
}
