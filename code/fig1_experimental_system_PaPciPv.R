...
# across the feasibility domain of a 3-species experimental system (Pa-Pci-Pv) 
...
# which norm to use
norm <- "l2"
# matrix to use (this is Pa-Pci-Pv system)
matrix_id <- 8
# load R data
...
# save plot
if (save_plots) {
  orca(fig_A, "figs/figSI/fig1/fig1_A_PaPciPv.pdf", format = "pdf",
       width = 700, height = 450)
}
...
# save plot
if (save_plots) {
  orca(fig_B, "figs/figSI/fig1/fig1_B_PaPciPv.pdf", format = "pdf",
       width = 700, height = 450)
}
...
# save plot
if (save_plots) {
  orca(fig_C, "figs/figSI/fig1/fig1_C_PaPciPv.pdf", format = "pdf",
       width = 700, height = 450)
}
...
# save plot
if (save_plots) {
  orca(fig_D, "figs/figSI/fig1/fig1_D_PaPciPv.pdf", format = "pdf",
       width = 700, height = 450)
}
